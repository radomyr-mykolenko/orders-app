...
@WebServlet("/InsertTestDataClientsTableServlet")
public class InsertTestDataClientsTableServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            queryUpdate.execute(SqlQueries.INSERT_CLINETS_TO_TABLE);
            connectDB.stop();
            response.setContentType("text/html");
            PrintWriter out = response.getWriter();
            out.println("<h3>Clients Inserted to table</h3>");
