...
@WebServlet("/CreateUsersTableServlet")
public class CreateUsersTableServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            queryUpdate.execute(SqlQueries.CREATE_USERS_TABLE);
            connectDB.stop();
            response.setContentType("text/html");
            PrintWriter out = response.getWriter();
            out.println("<h3>Table Users created</h3>");
